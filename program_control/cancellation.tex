...
The following example shows how the \kcode{cancel} directive can be used to terminate 
an OpenMP region. Although the \kcode{cancel} construct terminates the OpenMP 
